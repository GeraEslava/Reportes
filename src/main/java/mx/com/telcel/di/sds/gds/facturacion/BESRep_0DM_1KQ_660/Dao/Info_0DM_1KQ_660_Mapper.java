...
public class Info_0DM_1KQ_660_Mapper {
	...
	public static PagosFacturadosVo mapearRegioness(ResultSet rs) throws SQLException {
		PagosFacturadosVo test = new PagosFacturadosVo();
		...
		test.setNombreArchivo(rs.getString("ARCHIVO"));
		return test;
	}
